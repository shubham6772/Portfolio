...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Shubham Verma
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">
        I am a full stack developer with a passion for building websites and applications. I have experience working with both front-end and back-end technologies.
      </p>
